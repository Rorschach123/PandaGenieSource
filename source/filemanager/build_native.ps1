<#
.SYNOPSIS
    Standalone NDK build script for the filemanager module.
    Compiles libfilemanager.so for arm64-v8a and armeabi-v7a.
#>
param(
    [string]$NdkPath,
...
Write-Host "=== Building filemanager native library ===" -ForegroundColor Cyan
Write-Host "NDK: $ndk"
...
Write-Host ""
Write-Host "=== filemanager native build complete ===" -ForegroundColor Green
